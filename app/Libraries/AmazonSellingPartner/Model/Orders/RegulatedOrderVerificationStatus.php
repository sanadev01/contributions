...
class RegulatedOrderVerificationStatus implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'status' => '\AmazonSellingPartner\Model\Orders\VerificationStatus',
        'requires_merchant_action' => 'bool',
        'valid_rejection_reasons' => '\AmazonSellingPartner\Model\Orders\RejectionReason[]',
        'rejection_reason' => '\AmazonSellingPartner\Model\Orders\RejectionReason',
        'review_date' => 'string',
     ...
     * Sets status.
     *
     * @param \AmazonSellingPartner\Model\Orders\VerificationStatus $status status
     */
     ...
     *
     * @return \AmazonSellingPartner\Model\Orders\RejectionReason[]
     */
     ...
     *
     * @param \AmazonSellingPartner\Model\Orders\RejectionReason[] $valid_rejection_reasons a list of valid rejection reasons that may be used to reject the order's regulated information
     */
     ...
     *
     * @param null|\AmazonSellingPartner\Model\Orders\RejectionReason $rejection_reason rejection_reason
     */
