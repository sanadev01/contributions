...
use AmazonSellingPartner\Configuration\LoggerConfiguration;
use AmazonSellingPartner\Exception\InvalidArgumentException;
use AmazonSellingPartner\IdGenerator\UniqidGenerator;
use AmazonSellingPartner\STSClient\Credentials;
