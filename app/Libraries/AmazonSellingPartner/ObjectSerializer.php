...
use AmazonSellingPartner\Model\CatalogItem\ItemImage;
use AmazonSellingPartner\Model\FulfillmentInbound\CurrencyCode;
use AmazonSellingPartner\Model\FulfillmentInbound\PrepDetails;
use AmazonSellingPartner\Model\FulfillmentInbound\PrepInstruction;
use AmazonSellingPartner\Model\FulfillmentInbound\SellerFreightClass;
use AmazonSellingPartner\Model\FulfillmentInbound\ShipmentStatus;
use AmazonSellingPartner\Model\FulfillmentInbound\UnitOfMeasurement;
use AmazonSellingPartner\Model\FulfillmentOutbound\AdditionalLocationInfo;
use AmazonSellingPartner\Model\FulfillmentOutbound\CurrentStatus;
use AmazonSellingPartner\Model\FulfillmentOutbound\EventCode;
use AmazonSellingPartner\Model\MerchantFulfillment\FileType;
use AmazonSellingPartner\Model\MerchantFulfillment\LabelFormat;
...
final class ObjectSerializer
{
    ...
    public static function deserialize(Configuration $configuration, mixed $data, string $class, array $httpHeaders = null)
    {
        ...
        if (!empty($discriminator) && isset($data->{$discriminator}) && \is_string($data->{$discriminator})) {
            $subclass = '\AmazonSellingPartner\Model\\' . $data->{$discriminator};
