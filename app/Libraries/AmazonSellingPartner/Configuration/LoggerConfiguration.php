...
namespace AmazonSellingPartner\Configuration;
...
final class LoggerConfiguration
{
    ...
    private   $skippedAPIOperations;
 
    private   $skipHttpHeaders;
    ...
    {
        $this->skippedAPIOperations[$api]= $this->skippedAPIOperations[$api] ??[];
