...
namespace AmazonSellingPartner\Api\SellersApi;
...
final class SellersSDK implements SellersSDKInterface
{
     ...
     */
    public function getMarketplaceParticipations(AccessToken $accessToken, string $region) : \AmazonSellingPartner\Model\Sellers\GetMarketplaceParticipationsResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonSellingPartner\Model\Sellers\GetMarketplaceParticipationsResponse',
            []
        );
    }
