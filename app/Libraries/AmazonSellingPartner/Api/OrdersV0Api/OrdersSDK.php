...
namespace AmazonSellingPartner\Api\OrdersV0Api;
...
final class OrdersSDK implements OrdersSDKInterface
{
     ...
     * @param \AmazonSellingPartner\Model\Orders\ConfirmShipmentRequest $payload Request body of confirmShipment. (required)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException
     */
    public function confirmShipment(AccessToken $accessToken, string $region, string $order_id, \AmazonSellingPartner\Model\Orders\ConfirmShipmentRequest $payload)
    {
     ...
     */
    public function confirmShipmentRequest(AccessToken $accessToken, string $region, string $order_id, \AmazonSellingPartner\Model\Orders\ConfirmShipmentRequest $payload) : RequestInterface
    {
     ...
     * @throws InvalidArgumentException
     */
    public function getOrder(AccessToken $accessToken, string $region, string $order_id) : \AmazonSellingPartner\Model\Orders\GetOrderResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonSellingPartner\Model\Orders\GetOrderResponse',
            []
        );
    }
     ...
     * @throws InvalidArgumentException
     */
    public function getOrderAddress(AccessToken $accessToken, string $region, string $order_id) : \AmazonSellingPartner\Model\Orders\GetOrderAddressResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonSellingPartner\Model\Orders\GetOrderAddressResponse',
            []
        );
    }
     ...
     * @throws InvalidArgumentException
     */
    public function getOrderBuyerInfo(AccessToken $accessToken, string $region, string $order_id) : \AmazonSellingPartner\Model\Orders\GetOrderBuyerInfoResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonSellingPartner\Model\Orders\GetOrderBuyerInfoResponse',
            []
        );
    }
     ...
     * @throws InvalidArgumentException
     */
    public function getOrderItems(AccessToken $accessToken, string $region, string $order_id, ?string $next_token = null) : \AmazonSellingPartner\Model\Orders\GetOrderItemsResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonSellingPartner\Model\Orders\GetOrderItemsResponse',
            []
        );
    }
     ...
     * @throws InvalidArgumentException
     */
    public function getOrderItemsBuyerInfo(AccessToken $accessToken, string $region, string $order_id, ?string $next_token = null) : \AmazonSellingPartner\Model\Orders\GetOrderItemsBuyerInfoResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonSellingPartner\Model\Orders\GetOrderItemsBuyerInfoResponse',
            []
        );
    }
     ...
     * @throws InvalidArgumentException
     */
    public function getOrderRegulatedInfo(AccessToken $accessToken, string $region, string $order_id) : \AmazonSellingPartner\Model\Orders\GetOrderRegulatedInfoResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonSellingPartner\Model\Orders\GetOrderRegulatedInfoResponse',
            []
        );
    }
    ...
    public function getOrders(AccessToken $accessToken, string $region, array $marketplace_ids, ?string $created_after = null, ?string $created_before = null, ?string $last_updated_after = null, ?string $last_updated_before = null, ?array $order_statuses = null, ?array $fulfillment_channels = null, ?array $payment_methods = null, ?string $buyer_email = null, ?string $seller_order_id = null, ?int $max_results_per_page = null, ?array $easy_ship_shipment_statuses = null, ?array $electronic_invoice_statuses = null, ?string $next_token = null, ?array $amazon_order_ids = null, ?string $actual_fulfillment_supply_source_id = null, ?bool $is_ispu = null, ?string $store_chain_store_id = null, ?array $item_approval_types = null, ?array $item_approval_status = null) : \AmazonSellingPartner\Model\Orders\GetOrdersResponse
    {
        ...
        return ObjectSerializer::deserialize(
            $this->configuration,
            (string) $response->getBody(),
            '\AmazonSellingPartner\Model\Orders\GetOrdersResponse',
            []
        );
    }
     ...
     *
     * @param string $order_id An orderId is an Amazon-defined order identifier, in 3-7-7 format. (required)
     * @param \AmazonSellingPartner\Model\Orders\UpdateVerificationStatusRequest $payload The request body for the updateVerificationStatus operation. (required)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException
     */
    public function updateVerificationStatus(AccessToken $accessToken, string $region, string $order_id, \AmazonSellingPartner\Model\Orders\UpdateVerificationStatusRequest $payload)
    {
     ...
     * @throws \AmazonSellingPartner\Exception\InvalidArgumentException
     */
    public function updateVerificationStatusRequest(AccessToken $accessToken, string $region, string $order_id, \AmazonSellingPartner\Model\Orders\UpdateVerificationStatusRequest $payload) : RequestInterface
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (\is_array($order_id) && \count($order_id) === 0)) {
            throw new InvalidArgumentException(
