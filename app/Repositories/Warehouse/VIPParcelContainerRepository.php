...
class VIPParcelContainerRepository {
    ...
    public function get()
    {
        ...
        return $query->where(function($query) {
            $query->whereIn('services_subclass_code', [ShippingService::VIP_PARCEL_FCP, ShippingService::VIP_PARCEL_PMEI, ShippingService::VIP_PARCEL_PMI]);
        })->latest()->paginate();
