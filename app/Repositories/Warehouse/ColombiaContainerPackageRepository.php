...
class ColombiaContainerPackageRepository {
    ...
    public function addOrderToContainer($container, $order)
    {
        ...
        if ( (!$container->hasColombiaService() && $order->shippingService->isColombiaService()) 
            || ($container->hasColombiaService() && !$order->shippingService->isColombiaService())){
