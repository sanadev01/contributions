...
class MileExpressContainerPackageRepository {
    ...
    public function addOrderToContainer($container, $order)
    {
        ...
        if ( (!$container->hasMileExpressService() && $order->shippingService->isMileExpressService()) 
            || ($container->hasMileExpressService() && !$order->shippingService->isMileExpressService())){
