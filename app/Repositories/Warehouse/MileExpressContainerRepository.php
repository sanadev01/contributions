...
class MileExpressContainerRepository {
    ...
    public function get()
    {
        ...
        return $query->where(function($query) {
            $query->where('services_subclass_code', ShippingService::Mile_Express);
        })->latest()->paginate();
    ...
    public function store(Request $request)
    {
        try {
            ...
            $container =  Container::create([
                ...
                'unit_response_list' => $mileExpressContinerData ? json_encode($mileExpressContinerData) : null,
            ]);
