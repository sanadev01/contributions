...
class UserSettingRepository {
    ...
    public function store($request, $user){
        ...
        $userData = [
            ...
            'auto_charge_limit'=> setting('auto_charge_limit', null, $user->id) ? setting('auto_charge_limit', null, $user->id): 0,
            'auto_charge_amount'=> setting('auto_charge_amount', null, $user->id) ? setting('auto_charge_amount', null, $user->id): 0,
            'auto_charge' => setting('auto_charge', null, $user->id)? 'Active': 'Inactive',
        ...
        ($request->auto_charge_amount != null ) ? saveSetting('auto_charge_amount', $request->auto_charge_amount, $user->id) : saveSetting('auto_charge_amount', 0, $user->id);
        ($request->auto_charge_limit != null ) ? saveSetting('auto_charge_limit', $request->auto_charge_limit, $user->id) : saveSetting('auto_charge_limit', 0, $user->id);
