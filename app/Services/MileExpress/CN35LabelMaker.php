...
class CN35LabelMaker implements HasLableExport
{
    ...
    public function __construct(Container $container)
    {
        ...
        $this->originAirpot = $container->origin_airport ? $container->origin_airport : 'MIA';
    ...
    {
        return view('labels.mile-express.cn35.index',$this->getViewData());
    }

    public function download()
    {
        return \PDF::loadView('labels.mile-express.cn35.index',$this->getViewData())->stream();
    }

    public function saveAs($path)
    {
        return \PDF::loadView('labels.mile-express.cn35.index',$this->getViewData())->save($path);
    }
