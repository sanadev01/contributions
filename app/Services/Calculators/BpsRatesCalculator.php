...
class BpsRatesCalculator extends AbstractRateCalculator
{
    private $BpsRates;
    ...
    public function getRate($addProfit = true)
    {
        ...
        $rate = setting(Setting::SHIPPING_SERVICE_PREFIX.parent::SERVICE_BPS, null, null, true) ? $rate['bps'] : $rate['leve'];
    ...
    {
        try {
            if (! setting(Setting::SHIPPING_SERVICE_PREFIX.parent::SERVICE_BPS, null, null, true) && !setting(Setting::SHIPPING_SERVICE_PREFIX.parent::SERVICE_LEVE, null, null, true)) {
                return false;
            }
