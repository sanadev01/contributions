...
class CN35LabelMaker implements HasLableExport
{
    ...
    {
        return view('labels.colombia.cn35.index',$this->getViewData());
    }

    public function download()
    {
        return \PDF::loadView('labels.colombia.cn35.index',$this->getViewData())->stream();
    }

    public function saveAs($path)
    {
        return \PDF::loadView('labels.colombia.cn35.index',$this->getViewData())->save($path);
    }
