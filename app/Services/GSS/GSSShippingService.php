...
class GSSShippingService
{
    ...
    {
        if(($shippingService->service_sub_class == ShippingService::GSS_IPA || $shippingService->service_sub_class == ShippingService::GSS_EPMEI || $shippingService->service_sub_class == ShippingService::GSS_EPMI || $shippingService->service_sub_class == ShippingService::GSS_EFCM) && $this->weight <= $shippingService->max_weight_allowed)
        {
            return true;
        }
    }
