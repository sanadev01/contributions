...
class ImportAccrualRates extends AbstractImportService
{
    ...
    public function readRatesFromFile()
    {
        ...
        foreach (range(3, $limit) as $row) {
            ...
            if(($this->country_id == Country::Brazil && $weight <= 30000) || ($this->country_id == Country::Chile && $weight <= 50000) || ($this->country_id == Country::COLOMBIA && $weight <= 30000) || ($this->country_id == Country::US && $weight <= 30000))
            {
                $rates[] = [
