        ...
        if (optional($order)->shippingService) {
            switch ($order->recipient->country_id) {
                ...
                case ORDER::CHILE:
                    ...
                    break;
                case ORDER::BRAZIL:
                    if ($order->shippingService->sub_class_code == ShippingService::GePS || $order->shippingService->sub_class_code == ShippingService::GePS_EFormat || $order->shippingService->sub_class_code == ShippingService::GePS_EMS) {
