...
class CN23LabelMaker implements HasLableExport
{
    ...
    public function setOrder(Order $order)
    {
        ...
        if ($this->order->shippingService->isAnjunService()|| setting('anjun_api', null, User::ROLE_ADMIN) || setting('china_anjun_api', null, User::ROLE_ADMIN) || $this->order->shippingService->isAnjunChinaService()) {
