...
class CN35LabelMaker implements HasLableExport
{
    ...
    {
        return view('labels.vipparcel.cn35.index',$this->getViewData());
    }

    public function download()
    {
        return \PDF::loadView('labels.vipparcel.cn35.index',$this->getViewData())->stream();
    }

    public function saveAs($path)
    {
        return \PDF::loadView('labels.vipparcel.cn35.index',$this->getViewData())->save($path);
    }
