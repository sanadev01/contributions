...
class CourrierExpressLabelMaker implements HasLableExport
{
    private $order;
    private $recipient;
    private $partnerLogo;
    ...
    {
        return view('labels.chile.courrierexpress.index',$this->getViewData());
    }
    ...
    public function download()
    {
        ...
        return \PDF::loadView('labels.chile.courrierexpress.index',$this->getViewData())->stream();
    }
    ...
    public function saveAs($path)
    {
        ...
        return \PDF::loadView('labels.chile.courrierexpress.index',$this->getViewData())->save($path);
    }
