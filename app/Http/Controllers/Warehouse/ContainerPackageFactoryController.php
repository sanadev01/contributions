...
use App\Repositories\Warehouse\ContainerPackageFactoryRepository;

class ContainerPackageFactoryController extends Controller
{
    /**
    ...
    {
        return (new ContainerOrderExport((Container::find($id))->orders))->handle();
    }
    ...
    public function uploadBulkTracking(Request $request, $id)
    {
        ...
        return $packageFactoryRepo->addTrackings($request, $id);
    }
}
