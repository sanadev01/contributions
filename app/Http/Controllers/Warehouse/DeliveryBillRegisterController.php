...
class DeliveryBillRegisterController extends Controller
{
    public function __invoke(DeliveryBill $deliveryBill, DeliveryBillRepository $deliveryBillRepository)
    {
        ...
        if($deliveryBill->isGePS() || $deliveryBill->isSwedenPost() || $deliveryBill->hasColombiaService() || $deliveryBill->isPostPlus() || $deliveryBill->isAnjunChinaStandard()|| $deliveryBill->isAnjunChinaExpress())  {            
