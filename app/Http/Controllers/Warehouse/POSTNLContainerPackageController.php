...
class POSTNLContainerPackageController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('admin.warehouse.postnlContainers.scan',compact('container', 'ordersCollection', 'editMode'));
    ...
    {
        $postnl_containerPackageRepository = new PostNLContainerPackageRepository();

        return $postnl_containerPackageRepository->addOrderToContainer($container,$order);
    }
    ...
    public function destroy($container, $id)
    {
        ...
        try {
            //code...
            return $postnl_containerPackageRepository->removeOrderFromContainer($container,$id);
        } catch (\Exception $ex) {
            \Log::info($ex);
        }
    }
