...
class GSSContainerPackageController extends Controller
{
    /**
    ...
    public function index($id)
    {
        ...
        return view('admin.warehouse.gssContainers.scan',compact('container', 'editMode'));
    ...
    public function store($container, $order)
    {
        ...
        return $gssContainerPackageRepository->addOrderToContainer($container,$order);
    }
    ...
    public function destroy($container, $id)
    {
        ...
        try {
            //code...
            return $gssContainerPackageRepository->removeOrderFromContainer($container,$id);
        } catch (\Exception $ex) {
            \Log::info($ex);
        }
    }
