...
class SenegalContainerPackageController extends Controller
{
    /**
    ...
    public function index($id)
    {
        ...
        return view('admin.warehouse.senegalContainers.scan',compact('container', 'editMode'));
    ...
    public function store($container, $order)
    {
        ...
        return $senegalContainerPackageRepository->addOrderToContainer($container,$order);
    }
    ...
    public function destroy($container, $id)
    {
        ...
        try {
            //code...
            return $senegalContainerPackageRepository->removeOrderFromContainer($container,$id);
        } catch (\Exception $ex) {
            \Log::info($ex);
        }
    }
    ...
    public function uploadBulkTracking(Request $request, $id)
    {
        ...
        return $senegalContainerPackageRepository->addTrackings($request, $id);
    }
}
