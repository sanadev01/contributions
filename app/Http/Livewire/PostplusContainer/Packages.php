...
namespace App\Http\Livewire\PostplusContainer;
...
class Packages extends Component
{
    ...
    public function render()
    {
        ...
        $this->tracking = null;
        return view('livewire.postplus-container.packages',[
    ...
    public function submit()
    {
        ...
        if ($order){
            ...
            $response = $postPlusContainerPackageRepository->addOrderToContainer($container, $order);
            if(!$response['success']){
    ...
    {
        $postPlusContainerPackageRepository = new PostPlusContainerPackageRepository;
        $response = $postPlusContainerPackageRepository->removeOrderFromContainer($this->container, $id);
        $this->error = null;
    }
