...
namespace App\Http\Livewire\HoundContainer;

use App\Models\Order;
use Livewire\Component;
use App\Models\Warehouse\Container;
use App\Repositories\Warehouse\HoundContainerPackageRepository;
...
class Packages extends Component
{
    ...
    public function render()
    {
        ...
        $this->tracking = null;
        return view('livewire.hound-container.packages',[
    ...
    public function submit()
    {
        ...
        if ($order){
            ...
            $houndContainerPackageRepository = new HoundContainerPackageRepository;
            $response = $houndContainerPackageRepository->addOrderToContainer($container, $order);
            if(!$response['success']){
    ...
    {
        $houndContainerPackageRepository = new HoundContainerPackageRepository;
        $response = $houndContainerPackageRepository->removeOrderFromContainer($this->container, $id);
        $this->error = null;
    }
