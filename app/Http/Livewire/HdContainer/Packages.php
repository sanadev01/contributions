...
namespace App\Http\Livewire\HdContainer;
...
class Packages extends Component
{
    ...
    public function render()
    {
        ...
        $this->tracking = null;
        return view('livewire.hd-container.packages',[
    ...
    public function submit()
    {
        ...
        if ($order){
            ...
            $response = $hdExpressContainerPackageRepository->addOrderToContainer($container, $order);
            if(!$response['success']){
    ...
    {
        $hdExpressContainerPackageRepository = new HDExpressContainerPackageRepository;
        $response = $hdExpressContainerPackageRepository->removeOrderFromContainer($this->container, $id);
        $this->error = null;
    }
