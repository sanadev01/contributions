...
class Packages extends Component
{
    ...
    public function render()
    {
        ...
        $this->tracking = null;
        return view('livewire.colombia-container.packages',[
    ...
    public function submit()
    {
        ...
        if ($order){
            ...
            $response = $colombiaContainerPackageRepository->addOrderToContainer($container, $order);
            if(!$response['success']){
    ...
    {
        $colombiaContainerPackageRepository = new ColombiaContainerPackageRepository;
        $response = $colombiaContainerPackageRepository->removeOrderFromContainer($this->container, $id);
        $this->error = null;
    }
