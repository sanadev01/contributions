...
namespace App\Http\Livewire\VipparcelContainer;
...
class Packages extends Component
{
    ...
    public function render()
    {
        ...
        $this->tracking = null;
        return view('livewire.vipparcel-container.packages',[
    ...
    public function submit()
    {
        ...
        if ($order){
            ...
            $response = $vipParcelContainerPackageRepository->addOrderToContainer($container, $order);
            if(!$response['success']){
    ...
    {
        $vipParcelContainerPackageRepository = new VIPParcelContainerPackageRepository;
        $response = $vipParcelContainerPackageRepository->removeOrderFromContainer($this->container, $id);
        $this->error = null;
    }
