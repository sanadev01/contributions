...
namespace App\Http\Livewire\GdeContainer;
...
class Packages extends Component
{
    ...
    public function render()
    {
        ...
        $this->tracking = null;
        return view('livewire.gde-container.packages',[
    ...
    public function submit()
    {
        ...
        if ($order){
            ...
            $response = $gdeContainerPackageRepository->addOrderToContainer($container, $order);
            if(!$response['success']){
    ...
    {
        $gdeContainerPackageRepository = new GDEContainerPackageRepository;
        $response = $gdeContainerPackageRepository->removeOrderFromContainer($this->container, $id);
        $this->error = null;
    }
