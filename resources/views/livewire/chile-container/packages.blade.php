        ...
        <tbody>
            ...
            @foreach ($orders as $key => $order)
                <tr id="{{ $key }}">
                    ...
                    <td>
                        <button wire:click="removeOrder({{ $order->id }}, '{{ $key }}')"
            ...
            @if ($editMode == true)
                <tr>
                    <td colspan="8">
                        <input id="barcode" type="text" wire:model.debounce.500ms="barcode"
                            class="w-100 text-center" style="height:50px;font-size:30px;">
                    </td>
                </tr>
            @endif
        </tbody>
