        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
            ...
            @else
                    ...
                    <li class="nav-item has-sub sidebar-group">
                        ...
                        <ul class="menu-content">
                            ...
                            @can('viewAny', App\Models\HandlingService::class)
                                <li
                                    class="{{ $isActive(['admin.services.index', 'admin.services.edit', 'admin.services.create']) }}">
                ...
                @can('viewAny', App\Models\BillingInformation::class)
                    <li
                        class="nav-item {{ $isActive(['admin.deposit.index', 'admin.deposit.edit', 'admin.deposit.create']) }}">
