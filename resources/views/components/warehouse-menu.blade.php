...
<li class="nav-item has-sub sidebar-group">
    ...
    <ul class="menu-content">
        ...
        <li class="{{ $isActive(['warehouse.usps_containers.index','warehouse.usps_containers.create','warehouse.usps_containers.edit','warehouse.chile_container.packages.index']) }}">
