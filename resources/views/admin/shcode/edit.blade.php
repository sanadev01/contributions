        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    @section('title', __('Update ShCode'))
                ...
                <div class="card-content">
                    <div class="card-body paddinglr">
                        ...
                        @endif
                        <form action="{{ route('admin.shcode.update', $shcode->id) }}" method="post"
                            ...
                            <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="code"
                                        value="{{ old('code', $shcode->code) }}" placeholder="Enter ShCOde">
                            ...
                            <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="en"
                                        value="{{ old('en', optional(explode('-------', $shcode->description))[0]) }}"
                                        placeholder="Enter English language Details">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">Portuguese<span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="pt"
                                        value="{{ old('pt', optional(explode('-------', $shcode->description))[1]) }}"
                                        placeholder="Enter Portuguese language Details">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="sp"
                                        value="{{ old('sp', optional(explode('-------', $shcode->description))[2]) }}"
                                        placeholder="Enter Spanish language Details">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="row mt-1">
