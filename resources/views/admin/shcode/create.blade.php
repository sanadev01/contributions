        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    @section('title', __('Create ShCode'))
                            ...
                            <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="code"
                                        value="{{ old('code') }}" placeholder="Enter ShCOde">
                            ...
                            <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="en"
                                        value="{{ old('en') }}" placeholder="Enter English language Details">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="pt"
                                        value="{{ old('pt') }}" placeholder="Enter Portuguese language Details">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="sp"
                                        value="{{ old('sp') }}" placeholder="Enter Spanish language Details">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            <div class="row mt-1">
