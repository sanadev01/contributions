        ...
        <div>
            ...
            <div class="row mt-1">
                ...
                <div class="col-6 col-sm-6 col-md-3">
                    ...
                    <div class="controls form-group col-6 col-sm-6 col-md-3" id="div_state">
                    ...
                    {{-- Chile Regions --}}
                    <div class="controls form-group col-6 col-sm-6 col-md-3" id="div_region" style="display: none">
                    ...
                    <div class="form-group col-6 col-sm-6 col-md-3" id="state_input"  style="display: none">
                        <div class="controls">
                            <label>@lang('address.State') <span class="text-danger">*</span></label>
                ...
                <div class="form-group col-6 col-sm-6 col-md-3" id="div_street_number">
                    <div class="controls">
                ...
                <div class="form-group col-6 col-sm-6 col-md-3" id="cpf" style="display: none">
                    <div class="controls">
