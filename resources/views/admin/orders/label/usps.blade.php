        ...
        <div class="container">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="sender_address" value="{{ old('sender_address', __default($order->sender_address,optional($order->sender_address) ))}}" id="sender_address" placeholder="Enter you street address">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="sender_city" value="{{ old('sender_city', __default($order->sender_city,optional($order->sender_city) )) }}" id="sender_city" placeholder="Enter your city">
                    <div id="city_error">
