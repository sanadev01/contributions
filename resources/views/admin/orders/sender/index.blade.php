    ...
    <div class="content clearfix"> 
        ...
        <fieldset id="steps-uid-0-p-0" role="tabpanel" aria-labelledby="steps-uid-0-h-0" class="body current" aria-hidden="false">
            ...
            <div class="row">
                ...
                <div class="col-6 col-sm-6 col-md-3" id="tax_id">
                    <div class="form-group">
                ...
                <div class="col-6 col-sm-6 col-md-3 d-none" id="state">
                    <div class="form-group">
                ...
                <div class="col-6 col-sm-6 col-md-3" id="address" style="display: none">
                    <div class="form-group">
                ...
                <div class="col-6 col-sm-6 col-md-3" id="city" style="display: none">
                    <div class="form-group">
                ...
                <div class="col-6 col-sm-6 col-md-3 d-none" id="zip_code">
                    <div class="form-group">
                ...
                @if(setting('is_prc_user', null, $order->user->id))
                    <div class="col-6 col-sm-6 col-md-3" id="sender_website">
                        <div class="form-group">
