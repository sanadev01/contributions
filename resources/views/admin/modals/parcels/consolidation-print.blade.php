    ...
    <div class="table-responsive-md col-12">
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    <td>{{ $subOrder->length }} {{ $subOrder->is_weight_in_kg ? 'cm' : 'in' }}</td>
                    <td>{{ $subOrder->width }} {{ $subOrder->is_weight_in_kg ? 'cm' : 'in' }}</td>
                    <td>{{ $subOrder->height }} {{ $subOrder->is_weight_in_kg ? 'cm' : 'in' }}</td>
