        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    @section('title', __('billing.Add Billing Information'))
                    <a href="{{ route('admin.billing-information.index') }}"
                        class="pull-right btn btn-primary">@lang('billing.Back to List') </a>
                </div>
                <hr>
                <div class="card-content card-body paddinglr" id="credit-card">
                    @if ($errors->count())
                    ...
                    @endif
                    <form class="needs-validation" novalidate='novalidate' id="payment-form" method="POST"
                        action="{{ route('admin.billing-information.store') }}">
                        @csrf
                        ...
                        <div class="row mt-1">
                            <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                ...
                                <button type="reset"
                                    class="btn btn-outline-warning waves-effect waves-light">@lang('billing.Reset')</button>
                            </div>
                        </div>
