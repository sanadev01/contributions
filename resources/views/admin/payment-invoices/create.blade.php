            ...
            <div class="col-12">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('admin.payment-invoices.orders.store') }}" method="post"
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-12">
                                    <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th><input class="form-control" type="checkbox" value=""
                                                        id="checkAll"></th>
                                                <th>#</th>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-md-8 text-right">
                                    <a href="{{ route('admin.orders.index') }}"
                                        class="btn btn-primary btn-lg">@lang('invoice.Add More Orders')</a>
