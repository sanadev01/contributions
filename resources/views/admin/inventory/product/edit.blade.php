            ...
            <form class="form" action="{{ route('admin.inventory.product.update', $product->id ) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-body">
                    ...
                    {{-- <div class="controls row mb-1 align-items-center">
                        ...
                        <div class="col-md-6">
                            <select name="status" id="" class="form-control" >
                                ...
                                <option @if($product->status == '1') selected @endif value="1">Yes</option>
                                <option @if($product->status == '0') selected @endif value="0">No</option>
                            </select>
                            @error('status')
                                <div class="help-block text-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="controls row mb-1 align-items-center">
                        ...
                        <div class="col-md-6">
                            <textarea type="text" class="form-control" name="description" rows="8" placeholder="Enter Product Description">{{ $product->description }}</textarea>
                            @error('description')
                                <div class="help-block text-danger">{{ $message }}</div>
                            @enderror
                        </div>
