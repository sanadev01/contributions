...
@section('page')
    ...
    <div class="card-content">
        <div class="card-body no-print paddinglr" style="overflow-y: visible">
            <form class="form" action="{{ route('admin.inventory.product.store') }}" method="POST"
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" name="category"
                                    value="{{ old('category') }}" placeholder="Enter Product category" required>
                                @error('category')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="number" class="form-control" name="quantity"
                                    value="{{ old('quantity') }}" placeholder="Enter Product quantity" required>
                                @error('quantity')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="number" class="form-control" name="weight" step=".01"
                                    value="{{ old('weight') }}" placeholder="Enter Product weight" required>
                                @error('weight')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <select name="measurement_unit" class="form-control" required>
                                    <option {{ old('measurement_unit') == 'kg/cm' ? 'selected' : '' }}
                                        value="kg/cm">kg/cm</option>
                                    <option {{ old('measurement_unit') == 'lbs/in' ? 'selected' : '' }}
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" name="brand"
                                    value="{{ old('brand') }}" placeholder="Enter Product Brand" required>
                                @error('brand')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" value="{{ old('manufacturer') }}"
                                    placeholder="Enter Product Manufacturer" name="manufacturer" required>
                                @error('manufacturer')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" name="item"
                                    value="{{ old('item') }}" placeholder="Enter Item Number">
                                @error('item')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" name="lot"
                                    value="{{ old('lot') }}" placeholder="Enter lot number">
                                @error('lot')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" name="case"
                                    value="{{ old('case') }}" placeholder="Enter Product Case">
                                @error('case')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" name="min_quantity"
                                    value="{{ old('min_quantity') }}" placeholder="Enter Product Min Quantity"
                                    required>
                                @error('min_quantity')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" name="max_quantity"
                                    value="{{ old('max_quantity') }}" placeholder="Enter Product Max Quantity"
                                    required>
                                @error('max_quantity')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" name="discontinued"
                                    value="{{ old('discontinued') }}" placeholder="Enter Discontinued Item"
                                    required>
                                @error('discontinued')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" name="store_day"
                                    value="{{ old('store_day') }}" placeholder="Enter Number of days">
                                @error('store_day')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" name="location"
                                    value="{{ old('location') }}" placeholder="Enter warehouse location" required>
                                @error('location')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group col-12 col-sm-6 col-md-4">
                            <div class="controls">
                                ...
                                <input type="date" class="form-control" name="exp_date"
                                    value="{{ old('exp_date') }}" placeholder="Enter Expiry Date" required>
                                @error('exp_date')
                                    <div class="help-block text-danger">{{ $message }}</div>
                                @enderror
                            </div>
