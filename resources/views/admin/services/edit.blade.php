                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.services.update',$service) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="name" value="{{ old('name',$service->name) }}" placeholder="Name of Service">
                                        @error('name')
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" step="0.001" class="form-control" name="cost" placeholder="Cost of Service" value="{{ old('cost',$service->cost) }}">
                                        @error('cost')
                                            <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" step="0.001" class="form-control" name="price" placeholder="Price of Service" value="{{ old('price',$service->price) }}">
                                        @error('price')
                                            <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
