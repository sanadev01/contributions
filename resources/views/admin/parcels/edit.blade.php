        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    @section('title', __('parcel.Edit Parcel'))
                    <a href="{{ route('admin.parcels.index') }}" class="pull-right btn btn-primary"> @lang('parcel.Back to List')
                    </a>
                </div>
                <div class="card-content">
                    <div class="card-body paddinglr">
                        ...
                        @endif
                        <form novalidate="" action="{{ route('admin.parcels.update', $parcel) }}" method="post"
                            ...
                            <div class="row mt-1">
                                <div class="form-group col-12 col-sm-6 col-md-4">
                                    <div class="controls">
                                        ...
                                        <input type="text" class="form-control" name="merchant"
                                            value="{{ old('merchant', $parcel->merchant) }}" placeholder="">
                                        @error('merchant')
                                            <div class="help-block text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group col-12 col-sm-6 col-md-4">
                                    <div class="controls">
                                        <label>
                                            @if ($parcel->products->isEmpty())
                                                @lang('parcel.Carrier Inside')
                                            @else
                                                @lang('parcel.Fulfillment Order Number')
                                            @endif
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control"
                                            value="{{ old('carrier', $parcel->carrier) }}" placeholder=""
                                            name="carrier">
                                        @error('carrier')
                                            <div class="help-block text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="form-group col-12 col-sm-6 col-md-4">
                                    <div class="controls">
                                        <label>
                                            @if ($parcel->products->isEmpty())
                                                @lang('parcel.Tracking Inside')
                                            @else
                                                @lang('parcel.Fulfillment Order Description')
                                            @endif
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control" name="tracking_id"
                                            value="{{ old('tracking_id', $parcel->tracking_id) }}" placeholder="">
                                        @error('tracking_id')
                                            <div class="help-block text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                @can('addShipmentDetails', App\Models\Order::class)
                                    <div class="form-group col-12 col-sm-6 col-md-4">
                                        <div class="controls">
                                            <label>
                                                @if ($parcel->products->isEmpty())
                                                    @lang('parcel.External Customer Reference')
                                                @else
                                                    @lang('parcel.SKU Code')
                                                @endif
                                                <span class="text-danger"></span>
                                            </label>
                                            <input type="text" class="form-control"
                                                value="{{ old('customer_reference', $parcel->customer_reference) }}"
                                                placeholder="" name="customer_reference">
                                                ...
                                                <div class="controls">
                                                    @admin
                                                        <label>
                                                            ...
                                                            @else
                                                                @lang('parcel.Fulfillment Order Date')
                                                            @endif
                                                            <span class="text-danger">*</span>
                                                        </label>
                                                    @endadmin
                                ...
                                <div class="form-group col-12 col-sm-6 col-md-4 mt-3">
                                    <div class="controls mt-3">
                                        ...
                                        @if ($parcel->purchaseInvoice)
                                            <div class="mt-2">
                                                <a target="_blank" href="{{ $parcel->purchaseInvoice->getPath() }}"
                                                    class="m-2"> {{ $parcel->purchaseInvoice->name }} </a>
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                        ...
                                        <div class="controls">
                                            <div class="input-group">
                                                ...
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label"
                                                        for="inputGroupFile01">@lang('parcel.Select File')<span
                                                            class="text-danger">*</span></label>
                                                </div>
                                            </div>
                                        </div>
