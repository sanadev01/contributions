        ...
        <div class="btn-group">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right dropright">
                    ...
                    @endif
                    @can('update', $parcel)
                        <a @if (Auth::user()->isActive()) href="{{ route('admin.parcels.edit', $parcel->encrypted_id) }}" @else data-toggle="modal" data-target="#hd-modal" data-url="{{ route('admin.modals.user.suspended') }}" @endif
                    ...
                    @can('duplicatePreAlert', $parcel)
                        <a @if (Auth::user()->isActive()) href="{{ route('admin.parcel.duplicate', $parcel->encrypted_id) }}"  @else data-toggle="modal" data-target="#hd-modal" data-url="{{ route('admin.modals.user.suspended') }}" @endif
                            class="dropdown-item btn" title="@lang('parcel.Edit Parcel')">
                    ...
                    @if (auth()->user()->can('updateConsolidation', $parcel) && $parcel->isConsolidated())
                        <a @if (Auth::user()->isActive()) href="{{ route('admin.consolidation.parcels.edit', $parcel->encrypted_id) }}" @else data-toggle="modal" data-target="#hd-modal" data-url="{{ route('admin.modals.user.suspended') }}" @endif
