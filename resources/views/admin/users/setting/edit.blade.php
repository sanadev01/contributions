            ...
            <div class="col-12">
                ...
                <div class="card-content">
                    <div class="card-body paddinglr">
                        ...
                        @endif
                        <form action="{{ route('admin.users.setting.store', $user->id) }}" method="post"
                            enctype="multipart/form-data">
                            @csrf

                            <div class="controls row align-items-center" style="margin-bottom: 2.25rem !important;">
                                <label class="col-md-3 text-md-right">@lang('user.Default Package')<span
                                    ...
                                    <select name="package_id" class="form-control selectpicker" data-live-search="true">
                                        ...
                                        @isset($packages)
                                            @foreach ($packages as $package)
                                                <option @if ($user->package_id == $package->id) selected @endif
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('user.Role')<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('user.status')<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">Enable API<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                                    <input type="checkbox" name="api_enabled" id="api_enabled"
                                        @if ($user->api_enabled == 1) checked @endif>
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            ...
                            <hr>
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">Enable Amazon API<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                                    <input type="checkbox" name="amazon_api_enabled" id="api_enabled"
                                        @if ($user->amazon_api_enabled == 1) checked @endif>
                                    <div class="help-block"></div>
                                </div>
                            </div>

                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">Amazon Api key<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">Market Place Name<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                                    <input type="text" name="market_place_name" class="form-control"
                                        value="{{ $user->market_place_name }}">
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">Update Password<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('user.Referrer')<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                                    <select name="referrer_id[]" class="form-control selectpicker" multiple
                                        data-live-search="true">
                                        <option value="" disabled>@lang('user.Select Referrer')</option>
                                        @foreach ($users as $userRefferer)
                                            <option value="{{ $userRefferer->id }}"
                                                @if ($userRefferer->reffered_by == $user->id) selected @endif>
                                                {{ $userRefferer->name }} | {{ $userRefferer->pobox_number }}</option>
                                        @endforeach
                                    </select>
                                    <div class="help-block"></div>
                                </div>
                            ...
                            <hr>
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right" for="battery">Waive battery fee<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                                    <div class="vs-checkbox-con vs-checkbox-primary" title="Waive battery fee">
                                        <input type="checkbox" name="battery" id="battery"
                                            @if (setting('battery', null, $user->id)) checked @endif>
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">Waive perfume/aerosol/nail polish fee<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                                    <div class="vs-checkbox-con vs-checkbox-primary"
                                        title="Waive perfume/aerosol/nail polish fee">
                                        <input type="checkbox" name="perfume" id="perfume"
                                            @if (setting('perfume', null, $user->id)) checked @endif>
                                        <span class="vs-checkbox vs-checkbox-lg">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">Insurance<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                                    <div class="vs-checkbox-con vs-checkbox-primary" title="Insurance">
                                        <input type="checkbox" name="insurance" id="perfume"
                                            @if (setting('insurance', null, $user->id)) checked @endif>
                                        <span class="vs-checkbox vs-checkbox-lg">
                                            <span class="vs-checkbox--check">
                                                <i class="vs-icon feather icon-check"></i>
                                            </span>
                                ...
                                @endif
                                @if(setting('geps_eformat', null, \App\Models\User::ROLE_ADMIN))
                                <div class="controls row mb-1 align-items-center">
                                    <label class="col-md-3 text-md-right">GePS E-Format<span class="text-danger"></span></label>
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <div class="vs-checkbox-con vs-checkbox-primary" title="Global E Parcel">
                                                <input type="checkbox" name="geps_eformat" id="geps_eformat" @if(setting('geps_eformat', null, $user->id)) checked @endif>
                                                <span class="vs-checkbox vs-checkbox-lg">
                                                    <span class="vs-checkbox--check">
                                                        <i class="vs-icon feather icon-check"></i>
                                                    </span>
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">Volumetric Discount<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <div class="vs-checkbox-con vs-checkbox-primary" title="volumetric_discount">
                                            <input type="checkbox" name="volumetric_discount"
                                                id="volumetric_discount"
                                                @if (setting('volumetric_discount', null, $user->id)) checked @endif>
                                            <span class="vs-checkbox vs-checkbox-lg">
                                                <span class="vs-checkbox--check">
                                                    <i class="vs-icon feather icon-check"></i>
                                                </span>
                                        ...
                                        <input type="number" name="discount_percentage" class="form-control col-2"
                                            id="discount_percentage"
                                            value="{{ setting('discount_percentage', null, $user->id) }}">
                                    </div>
                                </div>
                            </div>
                            <div class="controls row align-items-center mt-2">
                                <label class="col-md-3 text-md-right">Weight (%)<span
                                        class="text-danger"></span></label>
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <div title="weight">
                                            <input class="form-control" step="0.01" min=0 type="number"
                                                name="weight" value="{{ setting('weight', null, $user->id) }}">
                                        </div>
                                        <span class="ml-4 mr-2 mt-2">Length (%): </span>
                                        <input type="number" name="length" class="form-control col-2"
                                            id="length" step="0.01" min=0 type="number"
                                            value="{{ setting('length', null, $user->id) }}">
                                        <span class="ml-4 mr-2 mt-2">Width (%): </span>
                                        <input type="number" name="width" class="form-control col-2"
                                            id="width" step="0.01" min=0 type="number"
                                            value="{{ setting('width', null, $user->id) }}">
                                        <span class="ml-4 mr-2 mt-2">Height (%): </span>
                                        <input type="number" name="height" class="form-control col-2"
                                            id="height" step="0.01" min=0 type="number"
                                            value="{{ setting('height', null, $user->id) }}">
                                    </div>
                                </div>
                            </div>
                                <div class="controls row mb-1 align-items-center">
