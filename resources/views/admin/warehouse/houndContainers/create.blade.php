            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('warehouse.hound_containers.index') }}" class="pull-right btn btn-primary">@lang('warehouse.containers.List Containers')</a>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('warehouse.hound_containers.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="destination_operator_name">
                                            ...
                                            <option value="LRD" {{ old('destination_operator_name') == 'SAOD' ? 'selected' : '' }}>LAREDO</option>
                                            <option value="MEX" {{ old('destination_operator_name') == 'CRBA' ? 'selecte' : '' }}>MEXICO</option>
                                        </select>
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="services_subclass_code">
                                            ...
                                            <option value="{{App\Models\ShippingService::HoundExpress}}" {{ old('services_subclass_code') == App\Models\ShippingService::HoundExpress ? 'selected': '' }}>Hound Express</option>
                                        </select>
