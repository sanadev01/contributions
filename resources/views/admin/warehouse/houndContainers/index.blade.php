            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('warehouse.hound_containers.create') }}" class="pull-right btn btn-primary"> @lang('warehouse.containers.Create Container') </a>
                    </div>
                                            ...
                                            <div class="btn-group">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropright">
                                                        <a href="{{ route('warehouse.hound_container.packages.index',$container) }}" class="dropdown-item w-100">
                                                            <i class="feather icon-box"></i> @lang('warehouse.actions.Packages')
                                                        </a>
                                                        @if( !$container->isRegistered() )
                                                            <a href="{{ route('warehouse.hound_containers.edit',$container) }}" class="dropdown-item w-100">
                                                                <i class="fa fa-edit"></i> @lang('warehouse.actions.Edit')
                                                            </a>
                                                            @if( !$container->isRegistered() && $container->hasOrders())
                                                                <a href="{{ route('warehouse.hound_container.createRequest',$container) }}" class="dropdown-item w-100">
                                                                    <i class="feather icon-box"></i> Registered Unit
                                                                </a>
                                                            @endif
                                                            @if( $container->unit_response_list )
                                                                <a href="{{ route('warehouse.hound_container.registerBox',$container) }}" class="dropdown-item w-100">
                                                                    <i class="feather icon-box"></i> Register MasterBox
                                                                </a>
                                                            @endif
                                                            <form action="{{ route('warehouse.hound_containers.destroy',$container) }}" class="d-flex" method="post" onsubmit="return confirmDelete()">
                                                                @csrf
                                                                @method('DELETE')
                                                        ...
                                                        @endif
                                                        @if( $container->isRegistered() )
                                                            <a href="{{ route('warehouse.hound_container.download',$container) }}" class="dropdown-item w-100">
