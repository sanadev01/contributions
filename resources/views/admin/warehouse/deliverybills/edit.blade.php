        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Edit Delivery Bill</h4>
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('warehouse.delivery_bill.update',$deliveryBill) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" name="container[]" class="form-control container" checked value="{{$container->id}}">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" name="container[]" class="form-control container" value="{{$container->id}}">
                                    </td>
                                    <td>
                                        {{ $container->dispatch_number  }}
                                    </td>
