                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="destination_operator_name">
                                            ...
                                            @if($hasPasarexService)
                                                <option value="BOG" {{ old('destination_operator_name') == 'BOG' ? 'selected' : '' }}>BOG</option>
                                            @else
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="services_subclass_code">
                                            ...
                                            <option value="{{$shippingService->service_sub_class}}" selected {{ old('services_subclass_code') == $shippingService->service_sub_class ? 'selected': '' }}>{{ $shippingService->name}}</option>
                                            @endforeach
                                        </select>
