            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('warehouse.geps_containers.index') }}" class="pull-right btn btn-primary">@lang('warehouse.containers.List Containers')</a>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('warehouse.geps_containers.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="services_subclass_code">
                                            ...
                                            <option value="537" {{ old('services_subclass_code') == App\Models\ShippingService::GePS ? 'selected': '' }}>Global eParcel</option>
                                        </select>
