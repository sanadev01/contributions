        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('warehouse.colombia-containers.index') }}" class="pull-right btn btn-primary">@lang('warehouse.containers.List Containers')</a>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('warehouse.colombia-containers.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="controls row mb-1 align-items-center my-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="destination_operator_name" required>
                            ...
                            <div class="controls row mb-1 align-items-center my-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="services_subclass_code" required>
                                        ...
                                        <option value="CO-UR" {{ old('services_subclass_code') == 'CO-UR' ? 'selected': '' }}>Colombia Urbano</option>
                                        <option value="CO-NA" {{ old('services_subclass_code') == 'CO-NA' ? 'selected': '' }}>Colombia Nacional</option>
                                        <option value="CO-TR" {{ old('services_subclass_code') == 'CO-TR' ? 'selected': '' }}>Colombia Trayetos</option>
                                    </select>
