            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('warehouse.chile_containers.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        {{-- <select class="form-control" name="origin_operator_name">
                                            ...
                                            <option value="MIA" {{ old('origin_operator_name',__default('MIA', 'MIA')) == 'MIA' ? 'selected' : '' }}>MIA</option>
                                            <option value="HKG" {{ old('origin_operator_name') == 'HKG' ? 'selected' : '' }}>HKG</option>
                                            <option value="JFK" {{ old('origin_operator_name') == 'JFK' ? 'selected' : '' }}>JFK</option>
                                            <option value="ORD" {{ old('origin_operator_name') == 'ORD' ? 'selected' : '' }}>ORD</option>
                                        </select> --}}
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="services_subclass_code">
                                            ...
                                            <option value="SRM" {{ old('services_subclass_code') == 'SRM' ? 'selected': '' }}>SRM</option>
                                            <option value="SRP" {{ old('services_subclass_code') == 'SRP' ? 'selected': '' }}>SRP</option>
                                        </select>
