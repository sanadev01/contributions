        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    @section('title', __('warehouse.containers.Create Container'))
                            ...
                            <div class="controls row mb-1 align-items-center my-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="destination_operator_name">
                                        ...
                                        <option value="MR"
                                            {{ old('destination_operator_name') == 'MR' ? 'selected' : '' }}>MR
                                            (Santiago)</option>
                                        <option value="RM"
                                            {{ old('destination_operator_name') == 'RM' ? 'selected' : '' }}>RM
                                            (Other Region)</option>
                                    </select>
                            ...
                            <div class="controls row mb-1 align-items-center my-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="services_subclass_code">
                                        ...
                                        <option value="SRM"
                                            {{ old('services_subclass_code') == 'SRM' ? 'selected' : '' }}>SRM
                                        </option>
                                        <option value="SRP"
                                            {{ old('services_subclass_code') == 'SRP' ? 'selected' : '' }}>SRP
                                        </option>
                                    </select>
