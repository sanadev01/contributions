            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('warehouse.chile_containers.index') }}" class="pull-right btn btn-primary">@lang('warehouse.containers.List Containers')</a>
                    </div>
                    <hr>
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('warehouse.chile_containers.update',$container) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="destination_operator_name">
                                            ...
                                            <option value="MR" {{ old('destination_operator_name', $container->destination_operator_name) == 'MR' ? 'selected' : '' }}>MR (Santiago)</option>
                                            <option value="RM" {{ old('destination_operator_name', $container->destination_operator_name) == 'RM' ? 'selected' : '' }}>RM (Other Region)</option>
                                        </select>
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="services_subclass_code" disabled>
                                            ...
                                            <option value="SRM" {{ old('services_subclass_code',$container->services_subclass_code) == 'SRM' ? 'selected': '' }}>SRM</option>
                                            <option value="SRP" {{ old('services_subclass_code',$container->services_subclass_code) == 'SRP' ? 'selected': '' }}>SRP</option>
                                        </select>
