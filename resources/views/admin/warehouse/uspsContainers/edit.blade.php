            ...
            <div class="col-12">
                ...
                <div class="card-content">
                    <div class="card-body paddinglr">
                        <form action="{{ route('warehouse.usps_containers.update', $container) }}" method="post"
                            ...
                            <div class="controls row mb-1 align-items-center my-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="destination_operator_name">
                                        ...
                                        <option value="MIA"
                                            {{ old('destination_operator_name', $container->destination_operator_name) == 'MIA' ? 'selected' : '' }}>
                                            Miami</option>
                                    </select>
