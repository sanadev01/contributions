            ...
            <div class="col-12">
                ...
                <div class="card-content">
                    <div class="card-body paddinglr">
                        <form action="{{ route('warehouse.usps_containers.store') }}" method="post"
                            ...
                            <div class="controls row mb-1 align-items-center my-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="destination_operator_name">
                                        ...
                                        <option value="MIA"
                                            {{ old('destination_operator_name') == 'MIA' ? 'selected' : '' }}>Miami
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="services_subclass_code">
                                        ...
                                        <option value="Priority"
                                            {{ old('services_subclass_code') == 'Priority' ? 'selected' : '' }}>
                                            Priority</option>
                                        <option value="FirstClass"
                                            {{ old('services_subclass_code') == 'FirstClass' ? 'selected' : '' }}>
                                            FirstClass</option>
                                    </select>
