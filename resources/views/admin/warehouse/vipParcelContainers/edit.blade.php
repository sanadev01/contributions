        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('warehouse.vip-parcel-containers.index') }}" class="pull-right btn btn-primary">@lang('warehouse.containers.List Containers')</a>
                </div>
                <hr>
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('warehouse.vip-parcel-containers.update', $container) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="controls row mb-1 align-items-center my-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="services_subclass_code" required>
                                        ...
                                        <option value="{{ App\Models\ShippingService::VIP_PARCEL_FCP }}" {{ old('services_subclass_code', $container->services_subclass_code) == App\Models\ShippingService::VIP_PARCEL_FCP ? 'selected': '' }}>VIP Parcel First Class</option>
                                        <option value="{{ App\Models\ShippingService::VIP_PARCEL_PMI }}" {{ old('services_subclass_code', $container->services_subclass_code) == App\Models\ShippingService::VIP_PARCEL_PMI ? 'selected': '' }}>VIP Parcel Priority Mail International</option>
                                        <option value="{{ App\Models\ShippingService::VIP_PARCEL_PMEI }}" {{ old('services_subclass_code', $container->services_subclass_code) == App\Models\ShippingService::VIP_PARCEL_PMEI ? 'selected': '' }}>VIP Parcel Priority Mail Express International</option>
                                    </select>
