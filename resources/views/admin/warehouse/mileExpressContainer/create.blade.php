        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('warehouse.mile_express_containers.index') }}" class="pull-right btn btn-primary">@lang('warehouse.containers.List Containers')</a>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('warehouse.mile_express_containers.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="controls row mb-1 align-items-center my-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="services_subclass_code" required>
                                        ...
                                        <option value="{{App\Models\ShippingService::Mile_Express}}" {{ old('services_subclass_code') == App\Models\ShippingService::Mile_Express ? 'selected': '' }}>Mile Express</option>
                                    </select>
