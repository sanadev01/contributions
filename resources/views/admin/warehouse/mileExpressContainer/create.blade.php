        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('warehouse.mile-express-containers.index') }}" class="pull-right btn btn-primary">@lang('warehouse.containers.List Containers')</a>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('warehouse.mile-express-containers.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="controls row mb-1 align-items-center my-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="services_subclass_code" required>
                                        ...
                                        <option value="ML-EX" {{ old('services_subclass_code') == 'ML-EX' ? 'selected': '' }}>Homedelivebr Express</option>
                                    </select>
