            ...
            <div class="col-12">
                ...
                <div class="card-content">
                    <div class="card-body paddinglr">
                        <form action="{{ route('warehouse.containers.update', $container) }}" method="post"
                            ...
                            <div class="controls row mb-1 align-items-center my-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="destination_operator_name">
                                        ...
                                        <option value="SAOD"
                                            {{ old('destination_operator_name', $container->destination_operator_name) == 'SAOD' ? 'selected' : '' }}>
                                            GRU</option>
                                        <option value="CRBA"
                                            {{ old('destination_operator_name', $container->destination_operator_name) == 'CRBA' ? 'selected' : '' }}>
                                            CWB</option>
                                    </select>
                            ...
                            <div class="controls row mb-1 align-items-center my-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="services_subclass_code" disabled>
                                        ...
                                        <option value="NX"
                                            {{ old('services_subclass_code', $container->services_subclass_code) == 'NX' ? 'selected' : '' }}>
                                            Packet Standard service</option>
                                        <option value="IX"
                                            {{ old('services_subclass_code', $container->services_subclass_code) == 'IX' ? 'selected' : '' }}>
                                            Packet Express service</option>
                                    </select>
