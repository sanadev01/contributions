            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('warehouse.sinerlog_containers.index') }}" class="pull-right btn btn-primary">@lang('warehouse.containers.List Containers')</a>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('warehouse.sinerlog_containers.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="destination_operator_name">
                                            ...
                                            <option value="GRU" {{ old('destination_operator_name') == 'GRU' ? 'selected' : '' }}>GRU</option>
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="services_subclass_code">
                                            ...
                                            <option value="SL-NX" {{ old('services_subclass_code') == 'SL-NX' ? 'selected': '' }}>SL Standard Modal</option>
                                            <option value="SL-IX" {{ old('services_subclass_code') == 'SL-IX' ? 'selected': '' }}>SL Express Modal</option>
                                            <option value="SL-XP" {{ old('services_subclass_code') == 'SL-XP' ? 'selected': '' }}>SL Small Parcels</option>
                                        </select>
