        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content card-body">
                    <div class="mt-1">
                        <scanner-table :container='@json($sinerlog_container)' :edit-mode="{{$sinerlog_container->is_registered ? 'false':'true'}}" :orders-collection='@json($sinerlog_container->getOrdersCollections())' />
                    </div>
                </div>
            </div>
        </div>
