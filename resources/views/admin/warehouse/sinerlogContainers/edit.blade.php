            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('warehouse.sinerlog_containers.update',$sinerlog_container) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="seal_no" required value="{{ old('seal_no',$sinerlog_container->seal_no) }}">
                                        @error('seal_no')
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="unit_type">
                                            ...
                                            <option value="1" {{ old('unit_type',$sinerlog_container->unit_type) == '1' ? 'selected' : '' }}>BAG</option>
                                            <option value="2" {{ old('unit_type',$sinerlog_container->unit_type) == '2' ? 'selected' : '' }}>BOX</option>
                                        </select>
                                        @error('unit_type')
                                            <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="destination_operator_name">
                                            ...
                                            <option value="GRU" {{ old('destination_operator_name',$sinerlog_container->destination_operator_name) == 'GRU' ? 'selected' : '' }}>GRU</option>
                                            <option value="CWB" {{ old('destination_operator_name',$sinerlog_container->destination_operator_name) == 'CWB' ? 'selected' : '' }}>CWB</option>
                                        </select>
                                ...
                                <div class="controls row mb-1 align-items-center my-2">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="services_subclass_code" disabled>
                                            ...
                                            <option value="SL-NX" {{ old('services_subclass_code',$sinerlog_container->services_subclass_code) == 'SL-NX' ? 'selected': '' }}>SL Standard Modal</option>
                                            <option value="SL-IX" {{ old('services_subclass_code',$sinerlog_container->services_subclass_code) == 'SL-IX' ? 'selected': '' }}>SL Express Modal</option>
                                            <option value="SL-XP" {{ old('services_subclass_code',$sinerlog_container->services_subclass_code) == 'SL-XP' ? 'selected': '' }}>SL Small Parcels</option>
                                        </select>
