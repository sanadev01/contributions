        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('warehouse.hd-express-containers.create') }}" class="pull-right btn btn-primary"> @lang('warehouse.containers.Create Container') </a>
                </div>
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropright">
                                                    <a href="{{ route('warehouse.hd-express-container.packages.index',$container) }}" class="dropdown-item w-100">
                                                        <i class="feather icon-box"></i> @lang('warehouse.actions.Packages')
                                                    </a>
                                                    @if( !$container->is_registered )
                                                    <a href="{{ route('warehouse.hd-express-containers.edit',$container) }}" class="dropdown-item w-100">
                                                        <i class="fa fa-edit"></i> @lang('warehouse.actions.Edit')
                                                    </a>
                                                    @if( !$container->is_registered && $container->has_orders)
                                                    <a href="{{ route('warehouse.hd-express-container.register',$container) }}" class="dropdown-item w-100">
                                                        <i class="feather icon-box"></i> Register Unit
                                                    </a>
                                                    @endif
                                                    <form action="{{ route('warehouse.hd-express-containers.destroy',$container) }}" class="d-flex" method="post" onsubmit="return confirmDelete()">
                                                        @csrf
                                                        @method('DELETE')
