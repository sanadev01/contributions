        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('warehouse.hd-express-containers.index') }}" class="pull-right btn btn-primary">@lang('warehouse.containers.List Containers')</a>
                </div>
                <hr>
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('warehouse.hd-express-containers.update', $container) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="controls row mb-1 align-items-center my-2">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="services_subclass_code" required>
                                        ...
                                        <option value="{{ App\Models\ShippingService::HD_Express }}" {{ old('services_subclass_code', $container->services_subclass_code) == App\Models\ShippingService::HD_Express ? 'selected': '' }}>HD Express</option>
                                    </select>
