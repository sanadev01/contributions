            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('warehouse.postnl_containers.create') }}" class="pull-right btn btn-primary"> @lang('warehouse.containers.Create Container') </a>
                    </div>
                                            ...
                                            <div class="btn-group">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropright">
                                                        <a href="{{ route('warehouse.postnl_container.packages.index',$container) }}" class="dropdown-item w-100">
                                                            <i class="feather icon-box"></i> @lang('warehouse.actions.Packages')
                                                        </a>
                                                        @if( $container->response == 0 )
                                                            <a href="{{ route('warehouse.postnl_containers.edit',$container) }}" class="dropdown-item w-100">
                                                                <i class="fa fa-edit"></i> @lang('warehouse.actions.Edit')
                                                            </a>

                                                            @if(count($container->orders) > 0)
                                                                <a href="{{ route('warehouse.postnl_container.register',$container) }}" class="dropdown-item w-100" id="register_unit">
                                                                    <i class="feather icon-box"></i> Register Unit
                                                                </a>
                                                            @endif

                                                            <form action="{{ route('warehouse.postnl_containers.destroy',$container) }}" class="d-flex" method="post" onsubmit="return confirmDelete()">
                                                                @csrf
                                                                @method('DELETE')
                                                        ...
                                                        @endif
                                                        @if ( $container->response != 0 )
                                                            <a href="{{ route('warehouse.postnl_container.download',$container) }}" class="dropdown-item w-100">
                                                                <i class="feather icon-box"></i> Get CN35
                                                            </a>
                                                            <a href="{{ route('warehouse.download.postnl_manifest_excel',$container) }}" class="dropdown-item w-100">
