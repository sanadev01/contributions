        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    @section('title', __('role.Update Role'))
                    ...
                    <div class="card-body paddinglr">
                        ...
                        <form action="{{ route('admin.roles.update', $role->id) }}" method="post"
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('role.Role Name')<span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="role_name"
                                        value="{{ old('role_name', $role->name) }}" placeholder="@lang('role.Role Name')">
