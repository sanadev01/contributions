        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    @section('title', __('shippingservice.Create Shipping Service'))
                ...
                <div class="card-content">
                    <div class="card-body paddinglr">
                        ...
                        @endif
                        <form action="{{ route('admin.shipping-services.store') }}" method="post"
                            ...
                            <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-6">
                                    <input type="text" required class="form-control" name="name"
                                        value="{{ old('name') }}" placeholder="@lang('shippingservice.Name')">
                                    @error('name')
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('shippingservice.Max length allowed')<span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="number" required class="form-control" name="max_length_allowed"
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('shippingservice.Max width allowed')<span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="number" required class="form-control" name="max_width_allowed"
                                        placeholder="@lang('shippingservice.ax width allowed')" value="{{ old('max_width_allowed') }}">
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('shippingservice.Min length allowed')<span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="number" required class="form-control" name="min_length_allowed"
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('shippingservice.Min width allowed')<span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="number" required class="form-control" name="min_width_allowed"
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('shippingservice.Max sum of all sides')<span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="number" required class="form-control" name="max_sum_of_all_sides"
                                        placeholder="@lang('shippingservice.Max sum of all sides')" value="{{ old('max_sum_of_all_sides') }}">
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('shippingservice.Contains battery charges')<span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="number" required class="form-control" name="contains_battery_charges"
                                        placeholder="@lang('shippingservice.Contains battery charges')"
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('shippingservice.Contains perfume charges')<span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="number" required class="form-control" name="contains_perfume_charges"
                                        placeholder="@lang('shippingservice.Contains perfume charges')"
                            ...
                            <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-6">
                                    <input type="number" required class="form-control"
                                        name="contains_flammable_liquid_charges" placeholder="@lang('shippingservice.Contains perfume charges')"
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('shippingservice.Active')<span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="service_sub_class" required
                                        ...
                                        @foreach (config('shippingServices.correios.sub_classess') as $key => $item)
                                            <option value="{{ $key }}"
                                                {{ old('service_sub_class') == $key ? 'selected' : '' }}>
                                                {{ $item }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="sinelrog-inputs d-none">
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="api" required class="form-control"
                                            name="api" placeholder="API" value="sinerlog"
                                            readonly>{{ old('api') }}</input>
                                        @error('api')
                                            <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                <div class="controls row mb-1 align-items-center all-products d-none">
                                    <label class="col-md-3 text-md-right">Max sum of all products<span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-6">
                                        <input type="number" class="form-control products-sum"
                                            name="max_sum_of_all_products" placeholder="Max sum of all products"
                                            value="{{ old('max_sum_of_all_products') }}" />
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="service_api_alias"
                                            id="service_api_alias" placeholder="Service API alias"
                                            value="{{ old('service_api_alias') }}" />
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    <label class="col-md-3 text-md-right">Min height allowed<span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-6">
                                        <input type="number" required class="form-control" name="min_height_allowed"
                                            id="min_height_allowed" placeholder="Min height allowed"
                                            value="{{ old('min_height_allowed') }}" />
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    <label class="col-md-3 text-md-right">Max height allowed<span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-6">
                                        <input type="number" required class="form-control" name="max_height_allowed"
                                            id="max_height_allowed" placeholder="Max height allowed"
                                            value="{{ old('max_height_allowed') }}" />
