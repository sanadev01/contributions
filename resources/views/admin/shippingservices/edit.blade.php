                            ...
                            <form action="{{ route('admin.shipping-services.update', $shippingService) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="sinelrog-inputs d-none">
                                    ...
                                    <div class="controls row mb-1 align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" required class="form-control" name="service_api_alias" value="{{ $shippingService->service_api_alias }}" placeholder="Service API alias" />
                                    ...
                                    <div class="controls row mb-1 align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" required class="form-control" name="min_height_allowed" placeholder="Min height allowed" value="{{ $shippingService->min_height_allowed }}" />
                                    ...
                                    <div class="controls row mb-1 align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            <input type="number" required class="form-control" name="max_height_allowed" placeholder="Max height allowed" value="{{$shippingService->max_height_allowed }}" />
