                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.shipping-services.update', $shippingService) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                    <input type="text" required class="form-control" value="{{$shippingService->name}}" name="name" value="{{ old('name') }}" placeholder="Name of Service">
                                        @error('name')
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" required class="form-control" value="{{$shippingService->max_length_allowed}}" name="max_length_allowed" placeholder="Max length allowed" value="{{ old('max_length_allowed') }}">
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" required class="form-control" value="{{$shippingService->max_width_allowed}}" name="max_width_allowed" placeholder="Max width allowed" value="{{ old('max_width_allowed') }}">
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" required class="form-control" value="{{$shippingService->min_length_allowed}}" name="min_length_allowed" placeholder="Min length allowed" value="{{ old('min_length_allowed') }}">
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" required class="form-control" value="{{$shippingService->min_width_allowed}}" name="min_width_allowed" placeholder="Min width allowed" value="{{ old('min_width_allowed') }}">
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" required class="form-control" value="{{$shippingService->max_sum_of_all_sides}}" name="max_sum_of_all_sides" placeholder="Max sum of all sides" value="{{ old('max_sum_of_all_sides') }}">
