                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.gss-rates.update',$gssRate) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="controls row mb-1 align-items-center mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number"  min=".01" step="0.01" class="form-control" name="api_discount" value="{{ old('api_discount',$gssRate->api_discount) }}" placeholder="@lang('gssRate.Api Discount')">
                                        @error('api_discount')
                                        <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                <div class="controls row mb-1 align-items-center mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" min=".01"  step="0.01" class="form-control" name="user_discount" value="{{ old('user_discount',$gssRate->user_discount) }}" placeholder="@lang('gssRate.User Discount')">
                                        @error('user_discount')
                                        <div class="help-block text-danger"> {{ $message }} </div>
                                        @enderror
                                    </div>
