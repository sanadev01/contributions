            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="mb-0">
                        @section('title', __('consolidation.Consolidate Request'))
                    </h4>
                ...
                <div class="card-content">
                    <div class="card-body paddinglr">
                        <div class="number-tab-steps wizard-circle wizard clearfix p-3" role="application"
                            id="steps-uid-0">
                            <div class="steps clearfix no-print">
                                <ul role="tablist">
                                    <li role="tab"
                                        class="first {{ in_array(request()->route()->getName(),['admin.consolidation.parcels.index'])? 'current': 'disabled' }}"
                                    ...
                                    <li role="tab"
                                        class="{{ in_array(request()->route()->getName(),['admin.consolidation.parcels.services.index'])? 'current': 'disabled' }}"
                                        aria-disabled="true">
