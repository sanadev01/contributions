        ...
        <div class="card-header">
            <div class="col-8 btnsDiv" style="display: flex;">
                <div id="printBtnDiv">
                    ...
                    <button title="Delete" id="trash" type="btn" class="btn btn-primary mr-1 mb-1">
                        <i class="feather icon-trash"></i>
                    </button>
                </div>
            </div>
            <div class="row filter" style="padding-right:0.5%;">
                <button type="btn" onclick="toggleOrderPageSearch()" id="orderSearch" class="btn btn-primary mr-1 mb-1">
