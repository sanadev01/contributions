                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        @can('create', App\Models\Connect::class)
                            <a href="{{ route('admin.roles.create') }}" class="pull-right btn btn-primary"> @lang('connect.New Integration') </a>
                        @endcan
                    </div>
                    <div class="card-content">
                        <div class="row justify-content-center">
                            <div class="col-md-4 p-5">
                                <a href="{{ route('admin.connect.shopify.create') }}">
                                    <div class="p-4 m-4 border rounded shadow-lg cursor-pointer">
                                        <svg id="logos-shopify-black">
