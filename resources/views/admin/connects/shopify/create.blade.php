        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('admin.connect.shopify.store') }}" method="post"
                            ...
                            <div class="controls row mb-1 align-items-center">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="connect_name"
                                        value="{{ old('connect_name') }}" placeholder="@lang('connect.Name')">
                                    @error('connect_name')
                            ...
                            <div class="controls row mb-1 align-items-center">
                                <label class="col-md-3 text-md-right">@lang('connect.Store Url')<span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="connect_store_url"
                                        value="{{ old('connect_store_url') }}" placeholder="@lang('connect.Store Url')">
