                    ...
                    <div class="row">
                            ...
                            <div class="row d-flex justify-content-between">
                                <div class="col-md-3 col-sm-6 custom-cards ">
                                    <div class="card imagecard imagecard-topimage pr-lg-2 mr-lg-2">
                                        ...
                                        <div class="card-body">
                                            <div>
                                                <h3 class="text-center font-weight-bold my-1 font-black" id="total">
                                                    0 </h3>
                                                <p class="text-center display-5 font-black"><strong>Total
                                                        Orders</strong></p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3 col-sm-6  custom-cards">
                                    <div class="card imagecard imagecard-topimage">
                                        ...
                                        <div class="card-body">
                                            <div>
                                                <h3 class="text-center font-weight-bold my-1 font-black" id="taxed">
                                                    0 </h3>
                                ...
                                <div class="col-md-3 col-sm-6  custom-cards">
                                    <div class="card imagecard imagecard-topimage">
                                        ...
                                        <div class="card-body">
                                            <div>
                                                <h3 class="text-center font-weight-bold my-1 font-black" id="delivered">
                                                    0 </h3>
                                                <p class="text-center display-5 font-black"><strong>Delivered</strong>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-3 col-sm-6  custom-cards ">
                                    <div class="card imagecard imagecard-topimage ml-xl-2 pl-xl-2">
                                        ...
                                        <div class="card-body">
                                            <div>
                                                <h3 class="text-center font-weight-bold my-1 font-black" id="returned">
                                                    0 </h3>
                                                <p class="text-center display-5 font-black"><strong>Returned</strong>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class=" col-lg-4 col-sm-12 d-flex flex-column justify-content-center ">
                            <div class="filter-card " id="filter-card">
                                ...
                                <form
                                    action="{{ $isScanKpi ? route('admin.reports.kpi-report-scan.index') : route('admin.reports.kpi-report.index') }}"
                                    method="GET">
                                    <label for="startDate " class="mt-3 mb-2 font-black"><strong>Start
                                            Date</strong></label><br>
                                    <div class="input-group">
                                        <input class="form-control py-2 mr-1 p-3" type="date" name="start_date"
                                            id="startDate">
                                    </div>
                                    <label for="end-date" class="mt-4 mb-2 font-black"><strong>End
                                            Date</strong></label><br>
                                    <div class="input-group">
                         ...
                         f                   type="date">
                                    ...
                                    <div class="input-group">
                                        <textarea id="tracking_code" value="tracking code" type="text"
                                            placeholder="Please Enter Tracking Codes" rows="4"
                                            class="form-control py-2 mr-1"
                                    ...
                                    <div class="d-flex justify-content-between mt-4 mb-3">
                                        <div>
                                            ...
                                            {{-- <button type="submit"
                                                class="btn btn-outline-success responsive-content "></button> --}}
                                        </div>
                                        <div>
                                </form>
                    ...
                    <tfoot class="search-header">
                        ...
                        <tbody>
                            ...
                            <tr class="count">
                                ...
                                <td>
                                    <p class="center-text">
                                        {{ $orderDates[optional($data)['numero']] }} </p>
                                </td>
                                <td>
                                    <p class="center-text">
                                        {{ $trackingCodeUsersName[optional($data)['numero']] }} </p>
                                </td>
                                <td>
                                ...
                                <td>
                                    <p class="center-text">
                                        <span>{{ optional($data)['categoria'] }}</span>
                                    </p>
                                </td>
                                <td>
                                    <p class="center-text">
                                        {{ optional(optional(optional($data)['evento'])[count($data['evento']) -
                                        1])['data'] }}
                                    </p>
                                </td>
                                <td>
                                    <p class="center-text">
                                        {{ optional(optional(optional($data)['evento'])[0])['data'] }}
                                    </p>
                                </td>
                                <td>
                                    <p class="center-text">
                                        {{ sortTrackingEvents($data, null)['diffDates'] }} </p>
                                </td>
                                <td>
                                    <p class="center-text">
                                        {{ optional(optional(optional($data)['evento'])[0])['descricao'] }}
                                    </p>
                                </td>
                                <td>
                                    <p class="center-text">
                                        {{ sortTrackingEvents($data, null)['taxed'] }}</p>
                                </td>
                                <td>
                                    <p class="center-text">
                                        {{ sortTrackingEvents($data, null)['delivered'] }}</p>
                                </td>
                                <td>
                                    <p class="center-text">
                                        {{ sortTrackingEvents($data, null)['returned'] }}</p>
                                </td>
                                @else
                                <td colspan="11">
