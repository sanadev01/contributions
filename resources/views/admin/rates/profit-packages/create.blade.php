...
@section('page')
    <div class="card">
        ...
        @section('title', __('profitpackage.create-package'))
    ...
    <div class="card-content collapse show">
        <div class="card-body">
            <form class="form" action="{{ route('admin.rates.profit-packages.store') }}" method="POST"
                ...
                <div class="row justify-content-center mt-1">
                    <div class="col-md-10">
                        ...
                        <select class="form-control" name="type">
                            ...
                            <option value="default" {{ old('package_name') == 'default' ? 'selected' : '' }}>Default
                            </option>
                        </select>
                        @error('package_name')
                            <div class="text-danger">
