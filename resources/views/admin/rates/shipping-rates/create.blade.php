...
@section('page')
    ...
    <div class="card-content collapse show">
        <div class="card-body paddinglr">
            <form class="form" action="{{ route('admin.rates.shipping-rates.store') }}" method="POST"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="controls">
                                    ...
                                    <select name="country_id" required class="form-control selectpicker show-tick"
                            ...
                            <div class="input-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="inputGroupFile01"
                                        name="csv_file" aria-describedby="inputGroupFileAddon01">
                                    @error('csv_file')
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu overlap-menu"
                                                    ...
                                                    @isset($shipping_services)
                                                        @foreach ($shipping_services as $service)
                                                            <a href="{{ route('admin.rates.shipping-rates.show', $service->id) }}"
                                                                target="_blank" class="dropdown-item">
                                                                <i class="feather icon-download"></i>{{ $service->name }}
                                                                @lang('shipping-rates.Download')
                                                            </a>
                                                        @endforeach
                                                    @endisset
