            ...
            <form class="form" action="{{ route('admin.rates.updateZoneProfit', $groupId) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body"><br>
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="zipstart">Zipcode Start at</label>
                                <input type="text" class="form-control" id="zipstart" value="{{ getGroupRange($groupId)['start'] }}" readonly>
                            </div>
                        </div>

                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="zipend">ZipCode End at</label>
                                <input type="text" class="form-control" id="zipend" value="{{ getGroupRange($groupId)['end'] }}" readonly>
                            </div>
                        </div>
