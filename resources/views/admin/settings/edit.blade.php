                            ...
                            <form action="{{ route('admin.settings.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    <label class="col-md-3 text-md-right">@lang('setting.Authorize Key')<span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="AUTHORIZE_KEY"
                                            value="{{ old('AUTHORIZE_KEY', setting('AUTHORIZE_KEY')) }}" required
                                            placeholder="@lang('setting.Authorize Key')">
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="PAYMENT_GATEWAY">
                                            <option value="AUTHORIZE"
                                                {{ setting('PAYMENT_GATEWAY') == 'AUTHORIZE' ? 'selected' : '' }}>
                                                Authorize</option>
                                            <option value="STRIPE"
                                                {{ setting('PAYMENT_GATEWAY') == 'STRIPE' ? 'selected' : '' }}>Stripe
                                            </option>
                                        </select>
                                        <div class="help-block"></div>
                                    </div>
