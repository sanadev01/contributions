        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <a href="{{ route('admin.addresses.index') }}" class="pull-right btn btn-primary">@lang('address.Back to List')
                    </a>
                </div>
                        ...
                        <form action="{{ route('admin.addresses.store') }}" method="post"
                                    ...
                                    <div class="form-group col-12 col-sm-6 col-md-4">
                                        <div class="controls">
                                            ...
                                            <select class="form-control" name="account_type" id="accountType" required
                                                placeholder="@lang('address.Type')">
                                                <option value="">@lang('address.Type')</option>
                                                <option value="individual"
                                                    {{ old('account_type') == 'individual' ? 'selected' : '' }}>
                                                    Individual</option>
                                ...
                                <div class="row mt-1">
                                    <div class="form-group col-12 col-sm-6 col-md-4">
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" name="first_name"
                                                value="{{ old('first_name') }}" placeholder="@lang('address.First Name')">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-sm-6 col-md-4">
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" name="last_name"
                                                value="{{ old('last_name') }}" required placeholder="@lang('address.Last Name')">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-sm-6 col-md-4">
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" name="email"
                                                value="{{ old('email') }}" required placeholder="@lang('address.Email')">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="form-group col-12 col-sm-6 col-md-4">
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" name="phone"
                                                value="{{ old('phone') }}" required placeholder="+55123456789">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="form-group col-12 col-sm-6 col-md-4">
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" name="address"
                                                ...
                                                placeholder="@lang('address.Address')" />
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="form-group col-12 col-sm-6 col-md-4">
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" placeholder="@lang('address.Address')2"
                                    ...
                                    <div class="form-group col-12 col-sm-6 col-md-4">
                                        <div class="controls">
                                            ...
                                            <input type="text" class="form-control" placeholder="@lang('address.Street No')"
                                                value="{{ old('street_no') }}" name="street_no">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-sm-6 col-md-4">
                                        <div class="controls">
                                            ...
                                            <input type="text" name="zipcode" value="{{ old('zipcode') }}"
                                                required class="form-control" placeholder="Zip Code" />
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-sm-6 col-md-4">
                                        <div class="controls">
                                            <label style="display: none" id="cpf_label_id">@lang('address.CPF') <span
                                                    class="text-danger">* (Brazil Only)</span> </label>
                                            <label id="cnpj_label_id">@lang('address.CNPJ') <span class="text-danger">*
                                                    (Brazil Only)</span> </label>
                                            <input type="text" name="tax_id" id="tax_id"
                                                value="{{ old('tax_id') }}" required class="form-control"
                                                placeholder="CNPJ" />
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                            ...
                            <div class="row mt-1">
                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end mt-1">
                                    ...
                                    <button type="reset"
                                        class="btn btn-outline-warning waves-effect waves-light">@lang('address.Reset')</button>
                                </div>
                            </div>
                        </form>
                    </div>
