                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.tax.update',$tax->id) }}" method="post" class="orders" enctype="multipart/form-data">
                                ...
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number"   step="0.01" class="form-control buyingBRRate" name="buying_br" value="{{ old('buying_br', $tax->buying_br) }}" placeholder="@lang('tax.Herco Buying Rate')" required>
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                <div class="controls row mb-1 align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number"  step="0.01" class="form-control sellingBRRate" name="selling_br" value="{{ old('selling_br', $tax->selling_br) }}" placeholder="@lang('tax.Herco Selling Rate')" required>
                                        <div class="help-block"></div>
                                    </div>
                                </div>
                                <div class="controls row mb-1 align-items-center">
