...
return [
    ...
    'Tracking' => 'Rastreamento',
    'Weight' => 'Peso',
    'Service Options' => 'Opções de Serviço',
    'Import Tax' => 'Imposto de Importação',
    'Total Cost' => 'Custo Total',
    'Actual Cost'=>'Custo Real',
    "Estimate tax & duty"=>"Estimate tax & duty",
    "DDP/PRC service not available"=>"Serviço DDP ou PRC não disponível para este método de envio.",
    ...
    'order-details' => [
        ...
        'order-item' => [
            ...
            'Total' => 'total',
            'Is Contains Dangrous Goods' => 'Este pacote contém bateria ou líquido inflamável?',
        ...
        'declaration' => '<p class="h3 text-danger"><strong>Aviso Legal</strong> : Ao clicar em salvar pedido, você concorda que li e confirmo que todas as informações nesta declaração foram preenchidas por mim e estão corretas e sou 100% responsável pelas informações que aqui constam.</p>',
