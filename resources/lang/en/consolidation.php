...
return [
    ...
    'description' => 'I hereby authorize HERCO FREIGHT dba HomedeliveryBR to open boxes to check contents, replace items; consolidate items or boxes or return order to the seller on my behalf ',
