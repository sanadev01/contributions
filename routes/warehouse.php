...
use App\Http\Controllers\Warehouse\MilliExpressCN35DownloadController;
...
Route::middleware(['auth'])->as('warehouse.')->group(function () {
    ...
    Route::get('container/milli-express/{container}/download', MilliExpressCN35DownloadController::class)->name('milli-express.container.download');
