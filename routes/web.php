...
Route::namespace('Admin')->middleware(['auth'])->as('admin.')->group(function () {
        ...
        Route::namespace('Rates')->prefix('rates')->as('rates.')->group(function () {
            ...
            Route::get('zone-profit/view-rates/{shipping_service_id}/{zone_id}', [\App\Http\Controllers\Admin\Rates\ZoneProfitController::class, 'viewRates'])->name('view-zone-cost');
