...
Route::get('/download-return-orders-1', function (Request $request) {
    set_time_limit(300);
    $codes = [
        "IX029553527BR",
        "IX029553558BR",
...
Route::get('/download-return-orders-2', function (Request $request) {
    set_time_limit(300);
    $codes = [
        "NA667055798BR",
        "NA667056011BR",
...
Route::get('/download-return-orders-3', function () {
    set_time_limit(300);
    $codes = [
        "NB013771904BR",
        "NB013781328BR",
...
Route::get('/download-return-orders-4', function (Request $request) {
    set_time_limit(300);
    $codes = [
        "NB131050424BR",
        "NB131197455BR",
...
Route::get('/download-return-orders-5', function (Request $request) {
    set_time_limit(300);
...
Route::get('/download-return-orders-6', function (Request $request) {
    set_time_limit(300);
    $codes = [
        "NB193596458BR",
        "NB193599922BR",
...
Route::get('/download-return-orders-7', function (Request $request) {
    set_time_limit(300);
    $codes = [
        "NB287974683BR",
        "NB287975499BR",
...
Route::get('/download-return-orders-8', function (Request $request) {
    set_time_limit(300);
    $codes = [
        "NB342203197BR",
        "NB342204277BR",
...
Route::get('/download-return-orders-9', function (Request $request) {
    set_time_limit(300);
...
Route::get('/download-return-orders-10', function (Request $request) {
    set_time_limit(300);
...
Route::get('/download-return-orders-11', function (Request $request) {
    set_time_limit(300);
...
Route::get('/download-return-orders-12', function (Request $request) {
    set_time_limit(300);
...
Route::get('/download-return-orders-13', function (Request $request) {
    set_time_limit(300);
    $codes = [
        "NB385823003BR",
        "NB385823215BR",
...
Route::get('/download-return-orders-14', function (Request $request) {
    set_time_limit(300);
    $codes = [
        "NB387446375BR",
        "NB387446888BR",
...
Route::get('/download-return-orders-15', function (Request $request) {
    set_time_limit(300);
    $codes = [
        "NB506338736BR",
        "NB506613645BR",
